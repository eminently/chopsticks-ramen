...
CalHeatMap.prototype = {
	...
	fill: function(svg) {
		...
		//console.log("current data: "+this.options.data.length)
		var parent = this;
		...
		//console.log("parent._domains="+JSON.stringify(parent._domains))
		...
		try {
			...
			//console.log("error: "+e+ " for domain: "+_d)
			return
		}
	...
	getSubDomain: function(date) {
		...
		//console.log("this.options.subDomain="+this.options.subDomain)
	...
	update: function(dataSource, afterLoad, updateMode) {
		...
		//console.log("domains keys : "+values)

		/*for (var i=0; i < values.length; i++) {
			console.log("domains keys : "+new Date(values[i]))
		}*/

		//console.log("domains length : "+domains.length)
		//console.log("subdomain : "+this.getSubDomain(domains[domains.length-1]))
		var subdomain = this.getSubDomain(domains[domains.length-1]).pop()
		//console.log("subdomain pop : "+subdomain)
		//console.log("subdomain pop date : "+new Date(Date.parse(subdomain)).getTime())
		//console.log("this.options.data="+this.options.data.length)
